...
void AdgprsSimulator::copyDriverFiles()
{
    ...
    std::cout << "Copying over include folder (include_ecl2adgprs)..." << std::endl;
    Utilities::FileHandling::CreateDirectory(output_directory_+"/include_ecl2adgprs");
    Utilities::FileHandling::CopyDirectory(initial_driver_file_parent_dir_path_+"/include_ecl2adgprs", output_directory_+"/include_ecl2adgprs");
