...
Optimizer::Optimizer(Utilities::Settings::Optimizer *settings, Case *base_case, Model::Properties::VariablePropertyContainer *variables)
{
    ...
    // QString out_string = "--UUID (optimizer.cpp):\nUUID : " + base_case->id().toString();
    // QString file_path = "/home/bellout/git/PCG/FieldOpt/examples/test-ADGPRS-5SPOT_WPLC-A";    
    // Utilities::FileHandling::WriteLineToFile(out_string, file_path + "/log_compdat.out");
