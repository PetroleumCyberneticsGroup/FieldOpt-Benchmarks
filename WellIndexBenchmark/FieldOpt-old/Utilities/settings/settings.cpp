...
Settings::Settings(QString driver_path, QString output_directory)
{
    ...
    std::cout << "Initializing settings: driver path set." << std::endl;
    readDriverFile();
    std::cout << "Initializing settings: driver file read." << std::endl;
    output_directory_ = output_directory;
    simulator_->output_directory_ = output_directory;
    std::cout << "...simulator.output_directory: " <<
                 simulator_->output_directory_.toStdString() << std::endl;
}
